...
import { CommandSignature, RedisArgument, RedisFunctions, RedisModules, RedisScripts, RespVersions, TypeMapping } from '@redis/client/lib/RESP/types';
import { RedisClientType, RedisClientOptions, WithModules, WithFunctions, WithScripts } from '@redis/client/lib/client';
...
import { MULTI_MODE, MultiMode } from '@redis/client/lib/multi-command';
...
export declare class RedisClientPool<M extends RedisModules = {}, F extends RedisFunctions = {}, S extends RedisScripts = {}, RESP extends RespVersions = 2, TYPE_MAPPING extends TypeMapping = {}> extends EventEmitter {
    ...
    sendCommand(args: Array<RedisArgument>, options?: CommandOptions): Promise<import("@redis/client/lib/RESP/types").ReplyUnion>;
