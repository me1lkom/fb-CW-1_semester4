...
import { RedisModules, RedisFunctions, RedisScripts, RespVersions, Command, CommandArguments, ReplyUnion } from '@redis/client/lib/RESP/types';
import { RedisClientType } from '@redis/client/lib/client';
import { ErrorReply } from '@redis/client/lib/errors';
...
export declare class RedisLegacyClient {
    ...
    static getTransformReply(command: Command, resp: RespVersions): import("@redis/client/lib/RESP/types").TransformReply | undefined;
