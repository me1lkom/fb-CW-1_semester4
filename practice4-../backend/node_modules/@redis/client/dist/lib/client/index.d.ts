...
/// <reference types="node" />
/// <reference types="node" />
import COMMANDS from '@redis/client/lib/commands';
import RedisSocket, { RedisSocketOptions } from '@redis/client/lib/client/socket';
import { CredentialsProvider } from '@redis/client/lib/authx';
import RedisCommandsQueue, { CommandOptions } from '@redis/client/lib/client/commands-queue';
import { EventEmitter } from 'node:events';
import { PubSubType, PubSubListener, PubSubTypeListeners, ChannelListeners } from '@redis/client/lib/client/pub-sub';
import { Command, CommandSignature, TypeMapping, CommanderConfig, RedisFunctions, RedisModules, RedisScript, RedisScripts, ReplyUnion, RespVersions, RedisArgument, ReplyWithTypeMapping, SimpleStringReply, TransformReply } from '@redis/client/lib/RESP/types';
import { RedisClientMultiCommandType } from '@redis/client/lib/client/multi-command';
import { MULTI_MODE, MultiMode, RedisMultiQueuedCommand } from '@redis/client/lib/multi-command';
import { ScanOptions, ScanCommonOptions } from '@redis/client/lib/commands/SCAN';
import { RedisLegacyClientType } from '@redis/client/lib/client/legacy-mode';
import { RedisPoolOptions } from '@redis/client/lib/client/pool';
import { RedisVariadicArgument } from '@redis/client/lib/commands/generic-transformers';
import { ClientSideCacheConfig, ClientSideCacheProvider } from '@redis/client/lib/client/cache';
import { CommandParser } from '@redis/client/lib/client/parser';
import { MaintenanceUpdate, MovingEndpointType, SMigratedEvent } from '@redis/client/lib/client/enterprise-maintenance-manager';
import { ClientRole } from '@redis/client/lib/client/identity';
...
export default class RedisClient<M extends RedisModules, F extends RedisFunctions, S extends RedisScripts, RESP extends RespVersions, TYPE_MAPPING extends TypeMapping> extends EventEmitter {
     ...
     */
    createPool(options?: Partial<RedisPoolOptions>): import("@redis/client/lib/client/pool").RedisClientPoolType<M, F, S, RESP, TYPE_MAPPING>;
    ...
    WATCH(key: RedisVariadicArgument): Promise<TYPE_MAPPING[43] extends import("@redis/client/lib/RESP/types").MappedType<infer T> ? ReplyWithTypeMapping<Extract<"OK", T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> | ReplyWithTypeMapping<Extract<Buffer, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> : "OK">;
    watch: (key: RedisVariadicArgument) => Promise<TYPE_MAPPING[43] extends import("@redis/client/lib/RESP/types").MappedType<infer T> ? ReplyWithTypeMapping<Extract<"OK", T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> | ReplyWithTypeMapping<Extract<Buffer, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> : "OK">;
    ...
    scanIterator(this: RedisClientType<M, F, S, RESP, TYPE_MAPPING>, options?: ScanOptions & ScanIteratorOptions): AsyncGenerator<TYPE_MAPPING[42] extends import("@redis/client/lib/RESP/types").MappedType<infer T> ? ReplyWithTypeMapping<Extract<import("@redis/client/lib/RESP/types").BlobStringReply<string>[], T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> : (TYPE_MAPPING[36] extends import("@redis/client/lib/RESP/types").MappedType<infer T> ? ReplyWithTypeMapping<Extract<Buffer, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> | ReplyWithTypeMapping<Extract<string, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> : string)[], void, unknown>;
    hScanIterator(this: RedisClientType<M, F, S, RESP, TYPE_MAPPING>, key: RedisArgument, options?: ScanCommonOptions & ScanIteratorOptions): AsyncGenerator<{
        field: TYPE_MAPPING[36] extends import("@redis/client/lib/RESP/types").MappedType<infer T> ? ReplyWithTypeMapping<Extract<Buffer, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> | ReplyWithTypeMapping<Extract<string, T extends StringConstructor ? string : T extends NumberConstructor ? number : T extends BooleanConstructor ? boolean : T extends BigIntConstructor ? bigint : T>, TYPE_MAPPING> : string;
