...
import { RedisArgument, ArrayReply, UnwrapReply, TypeMapping } from '@redis/client/lib/RESP/types';
import { StreamMessageRawReply } from '@redis/client/lib/commands/generic-transformers';
/**
...
declare const _default: {
     ...
     */
    readonly transformReply: (this: void, reply: UnwrapReply<ArrayReply<StreamMessageRawReply>>, preserve?: any, typeMapping?: TypeMapping) => import("@redis/client/lib/commands/generic-transformers").StreamMessageReply[];
};
