...
/// <reference types="node" />
import { RedisClusterOptions } from '@redis/client/lib/cluster';
import { RedisClientType } from '@redis/client/lib/client';
import { EventEmitter } from 'node:stream';
import { ChannelListeners } from '@redis/client/lib/client/pub-sub';
import { RedisArgument, RedisFunctions, RedisModules, RedisScripts, RespVersions, TypeMapping } from '@redis/client/lib/RESP/types';
