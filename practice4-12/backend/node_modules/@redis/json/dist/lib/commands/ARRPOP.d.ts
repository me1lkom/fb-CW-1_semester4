...
import { RedisArgument, ArrayReply, NullReply, BlobStringReply } from '@redis/client/lib/RESP/types';
...
declare const _default: {
    ...
    readonly transformReply: (this: void, reply: NullReply | BlobStringReply | ArrayReply<NullReply | BlobStringReply>) => string | number | boolean | Date | {
        [key: string]: import("@redis/client/lib/commands/generic-transformers").RedisJSON;
        [key: number]: import("@redis/client/lib/commands/generic-transformers").RedisJSON;
    } | NullReply | (import("@redis/client/lib/commands/generic-transformers").RedisJSON | NullReply)[] | null;
};
