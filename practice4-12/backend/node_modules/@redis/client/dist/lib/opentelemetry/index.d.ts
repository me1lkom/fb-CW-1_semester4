import { ObservabilityConfig } from "@redis/client/lib/opentelemetry/types";
...
export { OTelClientAttributes, OTEL_ATTRIBUTES, CONNECTION_CLOSE_REASON, CSC_RESULT, CSC_EVICTION_REASON, } from "@redis/client/lib/opentelemetry/types";
export { OTelMetrics } from "@redis/client/lib/opentelemetry/metrics";
export { ClientRegistry, ClientMetricsHandle, IClientRegistry, } from "@redis/client/lib/opentelemetry/client-registry";
