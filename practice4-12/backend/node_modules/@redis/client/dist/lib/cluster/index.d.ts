...
import { RedisClientOptions, RedisClientType, WithFunctions, WithModules, WithScripts } from '@redis/client/lib/client';
import { CommandOptions } from '@redis/client/lib/client/commands-queue';
import { CommandArguments, CommanderConfig, CommandSignature, TypeMapping, RedisArgument, RedisFunctions, RedisModules, RedisScripts, ReplyUnion, RespVersions } from '@redis/client/lib/RESP/types';
import { NON_STICKY_COMMANDS } from '@redis/client/lib/commands';
import { EventEmitter } from 'node:events';
import RedisClusterSlots, { NodeAddressMap, ShardNode } from '@redis/client/lib/cluster/cluster-slots';
import { RedisClusterMultiCommandType } from '@redis/client/lib/cluster/multi-command';
import { PubSubListener, PubSubListeners } from '@redis/client/lib/client/pub-sub';
import { RedisTcpSocketOptions } from '@redis/client/lib/client/socket';
import { ClientSideCacheConfig, PooledClientSideCacheProvider } from '@redis/client/lib/client/cache';
import { ClientIdentity } from '@redis/client/lib/client/identity';
...
export default class RedisCluster<M extends RedisModules, F extends RedisFunctions, S extends RedisScripts, RESP extends RespVersions, TYPE_MAPPING extends TypeMapping> extends EventEmitter {
     ...
     */
    get slots(): import("@redis/client/lib/cluster/cluster-slots").Shard<M, F, S, RESP, TYPE_MAPPING>[];
     ...
     */
    get masters(): import("@redis/client/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>[];
    /**
     ...
     * Use with {@link RedisCluster.prototype.nodeClient} to get the client for a specific node (master or replica).
     */
    get nodeByAddress(): Map<string, import("@redis/client/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING> | ShardNode<M, F, S, RESP, TYPE_MAPPING>>;
    /**
     * The current pub/sub node.
     */
    get pubSubNode(): (Omit<import("@redis/client/lib/cluster/cluster-slots").Node<M, F, S, RESP, TYPE_MAPPING>, "client"> & Required<Pick<import("@redis/client/lib/cluster/cluster-slots").Node<M, F, S, RESP, TYPE_MAPPING>, "client">>) | undefined;
    get isOpen(): boolean;
    /**
     * @internal
     ...
     * TODO
     */
    getMasters(): import("@redis/client/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>[];
    /**
     * @deprecated use `.slots[<SLOT>]` instead
     * TODO
     */
    getSlotMaster(slot: number): import("@redis/client/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>;
}
export {};
