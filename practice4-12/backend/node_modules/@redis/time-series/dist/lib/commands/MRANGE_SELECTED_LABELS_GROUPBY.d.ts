...
import { ArrayReply, BlobStringReply, MapReply, TuplesReply, RedisArgument, NullReply } from '@redis/client/lib/RESP/types';
import { RedisVariadicArgument } from '@redis/client/lib/commands/generic-transformers';
import { SampleRawReply, Timestamp } from '@redis/time-series/lib/commands/helpers';
import { TsRangeOptions } from '@redis/time-series/lib/commands/RANGE';
import { TsMRangeGroupBy, TsMRangeGroupByRawMetadataReply3 } from '@redis/time-series/lib/commands/MRANGE_GROUPBY';
...
declare const _default: {
    ...
    readonly transformReply: {
        readonly 2: (this: void, reply: import("@redis/time-series/lib/commands/MRANGE_SELECTED_LABELS").TsMRangeSelectedLabelsRawReply2, _?: any, typeMapping?: import("@redis/client/lib/RESP/types").TypeMapping | undefined) => MapReply<BlobStringReply<string>, {
