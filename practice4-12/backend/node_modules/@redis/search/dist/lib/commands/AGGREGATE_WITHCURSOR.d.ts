...
import { RedisArgument, ReplyUnion, NumberReply } from '@redis/client/lib/RESP/types';
import { AggregateRawReply, AggregateReply, FtAggregateOptions } from '@redis/search/lib/commands/AGGREGATE';
