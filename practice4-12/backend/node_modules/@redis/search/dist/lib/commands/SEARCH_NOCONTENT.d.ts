...
import { SearchRawReply } from '@redis/search/lib/commands/SEARCH';
declare const _default: {
     ...
     */
    readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, index: import("@redis/client/lib/RESP/types").RedisArgument, query: import("@redis/client/lib/RESP/types").RedisArgument, options?: import("@redis/search/lib/commands/SEARCH").FtSearchOptions | undefined) => void;
